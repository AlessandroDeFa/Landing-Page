...
tlArtists
  ...
  .from(
    ".overflow-img",
    { opacity: 0, duration: 1, ease: Power2.easeOut },
    "-=0.6"
  )
  .from(
    lineartist,
  ...
  .from(
    ".artist-text",
    { stagger: 0.5, y: 100, opacity: 0, duration: 1.5, ease: Power2.easeOut },
    "-=0.5"
  );
...
tlwork
  .from(".work-1", { opacity: 0, x: -200, duration: 1, ease: Power2.easeOut })
  .from(".work-2", { opacity: 0, duration: 1, ease: Power2.easeOut }, "-=0.5")
  .from(
    ".work-3",
    { opacity: 0, x: 200, duration: 1, ease: Power2.easeOut },
    "-=0.7"
  )
  .from(
    ".work-4",
    { opacity: 0, y: 200, duration: 1, ease: Power2.easeOut },
    "-=0.6"
  );
...
tlcontact
  .from(".title-contact", { y: 100, opacity: 0, duration: 1 })
  .from(
    ".container-info",
  ...
  .from(
    ".form-name",
    { opacity: 0, x: -100, duration: 1, ease: Power4.easeOut },
    "-=0.8"
  )
  .from(
    ".form-mail",
  ...
  .from(
    ".container-button",
    { opacity: 0, duration: 1, y: 100, ease: Power4.easeOut },
    "-=0.99"
  );
...
tlrev
  .from(".svg-reviews", { duration: 1, opacity: 0 })
