...
tltattoo
  .from(".tattoo-title, .tattoo-text", { opacity: 0, duration: 1, y: 100 })
...
tlpiercing
  .from(".piercing-title, .piercing-text", { opacity: 0, duration: 1, y: 100 })
  .from(".piercing-price-title", { opacity: 0, duration: 1, y: 100 }, "-=0.5")
  .from(
    ".price-animation1 p",
    { opacity: 0, duration: 1, stagger: 0.1, y: 100 },
    "-=0.5"
  )
  .from(
    ".price-animation2 p",
